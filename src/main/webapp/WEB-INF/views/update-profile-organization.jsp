...
<html>
    ...
    <body>
        ...
        <f:form action="${pageContext.request.contextPath}/organization/addOrganization" modelAttribute="Organization" role="form" enctype="multipart/form-data" acceptCharset="utf-8>">
            ...
            <input type="hidden" name="organization_ID" value="${provider.getOrganizationProfile().getOrganization_ID()}"/>

            <div class="form-group">
<!--                <label for="name">Nombre: </label><br/>-->
                <input type="hidden" name="name" id="name" class="form-control" value="${provider.getNameOrganization()}" maxlength="50" required autofocus/>
            </div>

            <div class="form-group">
                <label for="description">Descripcion:</label>
                <textarea name="description" class="form-control" rows="5" id="description" >${provider.getOrganizationProfile().getDescription()}</textarea>
            </div>
            <div class="form-group">
